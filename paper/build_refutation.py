...
OUT = os.path.join(HERE, "Refutation_Giza_SAR_Doppler_Tomography.pdf")
...
P("I reimplemented the pipeline exactly as disclosed: Doppler sub-aperture decomposition; "
  ...
  "known truth (Figure 1). Data are free X-band spotlight scenes from two independent sensors, Umbra "
  "and Capella &mdash; the same data class the 2025 work used.")
...
# ------------------------------------------------------------------ 4
P("4. What is real, and what would change my conclusion", h1)
...
P("All scenes are free Umbra Open Data (CC-BY 4.0). The reproduction pipeline, the controls, the "
  "stress tests (including the frequency-relabelling and surface-pinning demonstrations), and the "
  "scripts that generate every figure here are maintained in the project repository.")
...
refs = [
    ...
    "Umbra Open Data, AWS Registry of Open Data (CC-BY 4.0).",
    "National Mine Map Repository (OSMRE); Montana Bureau of Mines &amp; Geology (Butte ground truth).",
]
